    ...
    <footer className="relative bg-black text-white border-t border-white/10">
      <div className="container mx-auto py-10 px-6 md:px-10">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs tracking-[0.15em] uppercase">
          ...
          <Link href="/galerie" className="hover:text-white/70 transition-colors">
            Portfolio
          </Link>
        ...
        {/* Bas de footer */}
        <div className="mt-8 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-2 text-[11px] text-white/70 text-center">
